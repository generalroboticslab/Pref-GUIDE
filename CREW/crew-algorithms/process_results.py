...
def continue_training(data_path):
    exp_list = os.listdir('../Data/FINAL/' + data_path + '/guide')
    for exp in exp_list:
        # if 'bowling' in exp:
        #     print(exp)
        #     os.system('python crew_algorithms/ddpg envs=bowling envs.time_scale=1 collector.frames_per_batch=120 batch_size=120 \
        #     hf=True feedback_model=True continue_training=' + data_path + '/saved_training/' + exp + ' sub_name=' + data_path)
        if 'find_treasure' in exp:
            print(exp)
            os.system('python crew_algorithms/ddpg envs=find_treasure envs.time_scale=1 collector.frames_per_batch=240 batch_size=240 \
            hf=True feedback_model=True continue_training=' + data_path + '/saved_training/' + exp + ' sub_name=' + data_path)
        elif 'hide_and_seek_1v1' in exp:
            print(exp)
            os.system('python crew_algorithms/ddpg envs=hide_and_seek_1v1 envs.time_scale=1 collector.frames_per_batch=240 batch_size=240 \
            hf=True feedback_model=True continue_training=' + data_path + '/saved_training/' + exp + ' sub_name=' + data_path)
...
def eval(data_path):
    ...
    for exp in tamer_list:
        ...
        if 'find_treasure' in exp:
            print(exp)
            os.system('python crew_algorithms/deep_tamer/eval.py envs=find_treasure envs.time_scale=1 exp_path=' + data_path + '/deep_tamer/' + exp)
        elif 'hide_and_seek_1v1' in exp:
            print(exp)
            os.system('python crew_algorithms/deep_tamer/eval.py envs=hide_and_seek_1v1 envs.time_scale=1 exp_path=' + data_path + '/deep_tamer/' + exp)
    ...
    for exp in guide_list:
        ...
        if 'find_treasure' in exp:
            print(exp)
            os.system('python crew_algorithms/ddpg/eval.py envs=find_treasure envs.time_scale=1 exp_path=' + data_path + '/guide/' + exp)
        elif 'hide_and_seek_1v1' in exp:
            print(exp)
            os.system('python crew_algorithms/ddpg/eval.py envs=hide_and_seek_1v1 envs.time_scale=1 exp_path=' + data_path + '/guide/' + exp)
