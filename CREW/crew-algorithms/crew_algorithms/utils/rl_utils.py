...
def make_base_env(
    ...
    print(env_cfg.time_scale)

    if env_cfg.time_scale > 1.0:
        engine_configuration_channel.set_configuration_parameters(width=100, height=100, quality_level=10, time_scale=env_cfg.time_scale, target_frame_rate=50)#, capture_frame_rate=5)
