...
def make_plots(log_files, log_names, save_img_path=None):
    if save_img_path is None:
        save_img_path = 'crew_algorithms/sac/plots/' + get_time() + '/'
    else:
        save_img_path = 'crew_algorithms/sac/plots/' + save_img_path + '/'
...
if __name__ == "__main__":
    ...
    base = [
        "crew_algorithms/sac/logs/0228_2008_rl.json",
        "crew_algorithms/sac/logs/0228_2008_rl.json",
        "crew_algorithms/sac/logs/0228_2008_rl.json",
    ]

    deploy_history_hf = [
        "crew_algorithms/sac/logs/0306_0524_hf.json",
        "crew_algorithms/sac/logs/0306_0524_hf.json",
        "crew_algorithms/sac/logs/0306_0524_hf.json",
    ]

    deploy_history = [
        "crew_algorithms/sac/logs/0306_0508_rl.json", 
        "crew_algorithms/sac/logs/0306_0508_rl.json", 
        "crew_algorithms/sac/logs/0306_0508_rl.json", 
    ]

    deploy = [
        "crew_algorithms/sac/logs/0306_2025_rl.json", 
        "crew_algorithms/sac/logs/0306_2025_rl.json", 
        "crew_algorithms/sac/logs/0306_2025_rl.json", 
    ]

    deploy_hf = [
        "crew_algorithms/sac/logs/0306_2028_hf.json",
        "crew_algorithms/sac/logs/0306_2028_hf.json",
        "crew_algorithms/sac/logs/0306_2028_hf.json",
    ]

    heuristic = [
        "crew_algorithms/sac/logs/0228_2009_rl.json", # heuristic
        "crew_algorithms/sac/logs/0228_2009_rl.json",
        "crew_algorithms/sac/logs/0228_2009_rl.json",
    ]
    ...
    # base = [
    #     "crew_algorithms/sac/logs/0221_1108_rl.json",
    #     "crew_algorithms/sac/logs/0224_1140_rl_base_seed1.json",
    #     "crew_algorithms/sac/logs/0224_1140_rl.json",
    # ]

    # nodeploy = [
    #     "crew_algorithms/sac/logs/0222_0619_rl.json", # no aux
    #     "crew_algorithms/sac/logs/0223_1630_rl.json",
    #     "crew_algorithms/sac/logs/0223_2240_rl.json",
    # ]

    # deploy = [
    #     "crew_algorithms/sac/logs/0220_2354_rl.json", 
    #     "crew_algorithms/sac/logs/0223_2248_rl.json",
    #     "crew_algorithms/sac/logs/0224_0157_rl.json",
    # ]

    # aux = [
    #     "crew_algorithms/sac/logs/0224_1618_rl.json", # aux
    #     "crew_algorithms/sac/logs/0224_1639_rl.json",
    #     "crew_algorithms/sac/logs/0224_1640_rl.json",
    # ]

    # heuristic = [
    #     "crew_algorithms/sac/logs/heuristic_step_sr.json", # heuristic
    #     "crew_algorithms/sac/logs/0223_1623_rl.json",
    #     "crew_algorithms/sac/logs/0223_1625_rl.json",
    # ]
    ...
    #     # 'crew_algorithms/sac/logs/0219_2159_rl.json',
    #     # 'crew_algorithms/sac/logs/0220_0158_rl.json',
    #     # "crew_algorithms/sac/logs/0220_1026_rl.json"
    #     # "crew_algorithms/sac/logs/0221_0623_rl.json",
    #     "crew_algorithms/sac/logs/heuristic_step_sr.json", # heuristic
    #     # "crew_algorithms/sac/logs/0220_1925_rl.json",
    #     # "crew_algorithms/sac/logs/0220_2032_rl.json",
    #     # "crew_algorithms/sac/logs/0220_2313_rl.json",
    #     # "crew_algorithms/sac/logs/0220_2354_rl.json", # by step
    #     "crew_algorithms/sac/logs/0221_1705_rl.json", # by traj
    #     "crew_algorithms/sac/logs/0222_0619_rl.json", # not deployed
    #     "crew_algorithms/sac/logs/0221_1108_rl.json", # baseline
