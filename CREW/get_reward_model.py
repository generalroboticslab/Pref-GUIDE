...
# Server details
hostname = 'bc298-cmp-08.egr.duke.edu'     # or IP address
port = 22                        # default SSH port
username = 'zj90'
password = 'JZR2679925804@jzr'      # Optional if using key

# hostname = 'bc298-cmp-00.egr.duke.edu'     # or IP address
# port = 22                        # default SSH port
# username = 'lz273'
# password = 'Zlyidea3623!'      # Optional if using key


server_target_folder = 'Preference_based_guide_cont/reward_model'
local_target_folder = '../'

target_folder = 'hard_label_pretrain'
