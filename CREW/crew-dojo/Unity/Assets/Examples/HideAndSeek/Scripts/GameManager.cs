...
namespace Examples.HideAndSeek
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        // {
        //     int hiderCount = ActivePlayers.Values.Count(p => p) + ActiveAIPlayers.Count(p => p.Item2);
        //     int seekerCount = ActivePlayers.Values.Count(p => !p) + ActiveAIPlayers.Count(p => !p.Item2);
        //     Debug.Log("hider: "+hiderCount);
        //     Debug.Log("seeker: "+seekerCount);
        //     return hiderCount >= 2 && seekerCount >= 2;
        // }
