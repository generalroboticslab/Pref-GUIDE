...
namespace Examples.Tetris
{
    public class HumanInterface : FeedbackInterface
    {
        ...
        private void SendToggleTimestep()
        {
            _connection.SendStateMessage((long)NetOpCode.ToggleTimestep, "Toggle!");
        }

        private void SendNextTimestep()
        {
            _connection.SendStateMessage((long)NetOpCode.NextTimestep, "Next!");
        }
